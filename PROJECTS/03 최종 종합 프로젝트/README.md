...
* **실시간 + 과거 시뮬레이션 통합** → 실제 투자와 유사한 학습 환경 제공
* 사용자별 거래 이력 기반 **맞춤형 분석·리포트** 제공
* **RAG 챗봇**으로 직관적인 투자 인사이트 제공
* 기업 고객용 **Power BI + Fabric 대시보드** 구축

---

## 🔒 책임 있는 인공지능 구현

* **투명성**: 투자 보고서와 감성분석 근거를 명시
* **공정성**: 특정 종목·전략에 치우치지 않고 다양한 코인 데이터 활용
* **신뢰성**: 실시간 데이터 검증, 트랜잭션 기반 동시성 제어 적용
* **보안성**: Keycloak 인증, Azure Key Vault 기반 키 관리
* **안전성**: 무중단 배포(CI/CD) 및 로그 기록으로 서비스 안정성 확보
